...
- Files: `recipe/drafter_cotraining/hs_collector/model.py` (`HSCollectorManager.update_weights`), `recipe/drafter_cotraining/ray_trainer.py` (call site).
...
- File: `recipe/drafter_cotraining/drafter_engine.py` + `recipe/drafter_cotraining/engine_workers.py::_sync_drafter_frozen_modules`.
...
- File: `recipe/drafter_cotraining/engine_workers.py::update_weights` (`pass` placeholder).
