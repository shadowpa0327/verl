...
- File: `recipe/drafter_cotraining/drafter_engine.py` + `recipe/drafter_cotraining/fsdp_workers.py::_sync_drafter_frozen_modules`.
...
- File: `recipe/drafter_cotraining/fsdp_workers.py::update_weights` (`pass` placeholder).
