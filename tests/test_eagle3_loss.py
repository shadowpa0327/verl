...
Mirrors reference/TorchSpec/tests/test_eagle3_loss.py but imports from verl.models.eagle3.
...
from verl.models.eagle3.draft.llama3_eagle import LlamaForCausalLMEagle3
from verl.models.eagle3.eagle3_model import (
    Eagle3Model,
    PrecomputedTarget,
    compute_lazy_target_padded,
    compute_target_p_padded,
)
from verl.models.eagle3.ops.loss import (
